...
📖 Overview
This project is a live geospatial data server and visualization platform designed specifically for district planners and administrators of Almora. Its primary goal is to provide a centralized, real-time interface for accessing and visualizing critical spatial data for the Almora district, including:
...
✨ Key Features
Real-time Data Sync: Automatically connects to a secure database to download and update geographical boundaries, river streams, and village data for Almora.
...
🚀 Live Demo
A live version of the application is hosted on Railway and can be accessed here:
...
If you have initial shapefiles for Almora, you would need to import them into your MongoDB collection. The specific script for this is not detailed in the live app but would typically be a custom import routine.
...
Data Source: The latest spatial data (shapefiles) for Almora is stored in a MongoDB database.
